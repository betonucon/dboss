        ...
        <div class="panel panel-success" data-sortable-id="ui-widget-11" >
            ...
            <div class="panel-body">
                <div class="btn-group" style="margin-bottom:2%">
                    <button class="btn btn-blue btn-sm active" onclick="verifikasi()"><i class="fa fa-plus-circle"></i> Verifikasi </button>
                </div>
                    ...
                    <table id="datafixedheader" class="table table-striped table-bordered table-td-valign-middle">
                        <thead>
                            <tr>
                                <th width="5%">No</th>
                                <th width="3%"></th>
                                <th class="text-wrap"  width="20%">Intansi</th>
        ...
        <div class="row">
            ...
            <div class="modal" id="modal-ubah" aria-hidden="true" style="display: none;background: #1717198a;">
                <div class="modal-dialog modal-lg" style="margin-top:0px">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Informasi Karyawan</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <div class="modal-body" style="background: #b5b5d330;">
            ...
            <div class="modal fade" id="modal-verifikasi" style="display: none;background: #1717198a;" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body" style="background: #eb161636;">
                            <div class="alert alert-yellow fade show m-b-10">
                                ...
                                Informasi <a href="#" class="alert-link">Jika anda melakukan proses varifikasi maka data karyawan terkait akan diberikan izin untuk masuk ke area PT Krakatau Steel</a>.
                            </div>
                        </div>
                        <div class="modal-footer">
                            <a href="javascript:;" class="btn btn-primary" onclick="verifikasi_data()" >Verifikasi</a>
                            <a href="javascript:;" class="btn btn-white" data-dismiss="modal">Tutup</a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function verifikasi_data(){
            ...
            var token= "{{csrf_token()}}";
                $.ajax({
                    type: 'POST',
                    url: "{{url('/Karyawan/verifikasi')}}?_token="+token,
                    data: new FormData(form),
                    contentType: false,
                    cache: false,
                    processData:false,

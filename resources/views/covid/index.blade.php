    ...
    <div id="content" class="content">
        ...
        <div class="panel panel-success" data-sortable-id="ui-widget-11" >
            <div class="panel-heading">
                <h4 class="panel-title">List Riwayat Covid</h4>
            ...
            <div class="panel-body">
                <div class="btn-group" style="margin-bottom:2%">
                    <button class="btn btn-blue btn-sm active" onclick="tambah_data()"><i class="fa fa-plus-circle"></i> Tambah Riwayat</button>
                    <button class="btn btn-red  btn-sm active" onclick="reset_data()"><i class="fa fa-cog"></i> Reset Riwayat</button>
                </div>
                    ...
                    <table id="datafixedheader" class="table table-striped table-bordered table-td-valign-middle">
                        <thead>
                            <tr>
                                ...
                                <th class="text-nowrap">Riwayat</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @foreach($data as $no=>$o)
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{$o->karyawan['nik']}}</td>
                                    <td>{{$o->nik_ktp}}</td>
                                    <td>{{$o->karyawan['name']}}</td>
                ...
                <div class="modal-dialog modal-lg" style="margin-top:0px">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Riwayat Covid</h4>
                           ...
                           <form id="mycreate" onkeypress="return event.keyCode != 13" action="{{url('Karyawan')}}" method="post" enctype="multipart/form-data">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a href="#default-tab-1" data-toggle="tab" class="nav-link active">
                                            ...
                                            <span class="d-sm-block d-none">Data Riwayat Covid</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content" style="margin-bottom:0px;padding:1%">
						            <div class="tab-pane fade active show" id="default-tab-1">
                                        ...
                                        <div class="col-xl-10 offset-xl-1">
                                            <div class="form-group row m-b-10">
                                                <label class="col-lg-5 text-lg-right col-form-label"><b>Riwayat Tangal(Dari & Sampai)</b></label>
                                                <div class="col-lg-9 col-xl-4">
                                                    <input type="text"  name="tgl_mulai" id="datepicker" placeholder="Enter....." class="form-control">
                                                </div>
                                                <div class="col-lg-9 col-xl-3">
                                                    <input type="text"  name="tgl_sampai" id="datepicker2" placeholder="Enter....." class="form-control">
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        function reset_data(){
            ...
            var token= "{{csrf_token()}}";
                $.ajax({
                    type: 'POST',
                    url: "{{url('/Covid/reset')}}?_token="+token,
                    data: new FormData(form),
                    contentType: false,
                    cache: false,
                    processData:false,
